...
namespace ActiveDirectory
{
    public class ADUserDetail
    {
        ...
        public string FullName
        {
            get
            {
                return String.Concat(_firstName, " ", _middleName, " ", _lastName).Replace("  "," ");
            }
        }
        ...
        private ADUserDetail(DirectoryEntry directoryUser)
        {
            ...
            {
                string[] userXdomain = userPrincipalName.Split('@');
                domainAddress = userXdomain.Length > 1 ? userXdomain[1] : null;
            }
            else
            {
